  ...
  Future<Database> openDB() async {
    ...
    return openDatabase(
      ...
      onCreate: (db, version) {
        print('create DB');
        db.execute(
            'create table $NOTE_TABLE ( $NOTE_COLUMN_ID integer primary key autoIncrement, $NOTE_COLUMN_AMOUNT real, $NOTE_COLUMN_BALANCE real, $NOTE_COLUMN_CREATED_AT text, $NOTE_COLUMN_TYPE text)');
      },
    );
  }
